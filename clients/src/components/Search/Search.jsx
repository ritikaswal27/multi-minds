  ...
  return (
    <>
      ...
      <div className='container search-page'>
        <form
          method='get'
          style={{ display: categoryActive || authorActive ? 'none' : '' }}
        ...
        <form
          method='get'
          style={{ display: authorActive ? '' : 'none' }}
          className='search-bar'
        >
          <input
        ...
        <form
          method='get'
          style={{ display: categoryActive ? '' : 'none' }}
          className='search-bar'
        >
          <input
        ...
        <div className='search-result'>
          <div className='search-query'>
            <button
              style={{
                borderBottom: blogActive
                  ? '2px solid rgba(0, 170, 161, 1)'
                  : 'none',
              }}
              id='blogs'
              onClick={act}
              className='blog-related-search'
            >
              Blogs
            </button>
            <button
              id='authors'
              style={{
                borderBottom: authorActive
                  ? '2px solid rgba(0, 170, 161, 1)'
                  : 'none',
              }}
              onClick={act}
              className='author-related-search'
            >
              Authors
            </button>
            <button
              id='category'
              style={{
                borderBottom: categoryActive
                  ? '2px solid rgba(0, 170, 161, 1)'
                  : 'none',
              }}
              onClick={act}
              className='category-related-search'
            >
              Category
            </button>
          </div>
