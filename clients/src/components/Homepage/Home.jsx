...
function Blog(props) {
  ...
  const farhanBlog1 = async () => {
    const res = await getBlogById('6506b6388a167e14c44b20ed');
    setBlog1(res.data.message);
  };
  const farhanBlog2 = async () => {
    const res = await getBlogById('6506b80d8a167e14c44b22e4');
          ...
          >
            <div className='minor-info mt-3'>
              ...
              <div className='icons-flex'>
                ...
                &nbsp;
                <p className='publishdate'>{blog1.publishDate}</p>
              </div>
              &nbsp;
              <div className='icons-flex'>
                | &nbsp;
                ...
                &nbsp;
                <p className='publishdate'>{blog1.readtime}</p>
              </div>
            </div>
          </a>
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: blog1.description?.slice(0, 150),
            }}
          ></div>
        </a>
      </div>
      ...
      <div className='blog'>
        ...
        <a href={`/blog/${blog2._id}`}>
          ...
          >
            <div className='minor-info mt-3'>
              ...
              <div className='icons-flex'>
                ...
                &nbsp;
                <p className='publishdate'>{blog2.publishDate}</p>
              </div>
              &nbsp;
              <div className='icons-flex'>
                | &nbsp;
          ...
          <div
            className='intro'
            dangerouslySetInnerHTML={{
              __html: blog2.description?.slice(0, 150),
            }}
          ></div>
        </a>
      </div>
...
function PopularAuthors(props) {
  ...
  const farhan = async () => {
    const res = await getUserById('6505a123c5d2c70581657002');
